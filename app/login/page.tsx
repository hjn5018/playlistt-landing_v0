  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (identifier && password && password.length >= 6) {
        // In a real app, you would redirect to the dashboard/home page after successful login
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 bg-gradient-to-b from-purple-50 to-white dark:from-purple-950/20 dark:to-background">
        <Card className="mx-auto max-w-md w-full">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Log in to your Playlistt account</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/finding-pwd" className="text-xs text-purple-600 hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                  <Input
